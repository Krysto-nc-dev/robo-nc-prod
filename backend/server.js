...
import factureDetailsRoutes from "./routes/factureDetailRoute.js";
...
app.use("/qc-factures", factureRoutes);
app.use("/qc-facture-details", factureDetailsRoutes);
app.use("/qc-commandes", commandeRoutes);
